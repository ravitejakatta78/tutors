...
$newOrdersCount = (array_values(array_filter(array_column($newOrdersDetail,'orderprocess')))); 		?>
		<button class="btn orderactive btn-block" onclick="runningOrder('1')">Dine In <span class="ml-1 badge badge-success"><?= count($dineIn) ?? 0; ?></span></button>
		</div>
		<div class="col-md-4 text-center">
		<button class="btn btn-block btn-info" onclick="runningOrder('3')">New Orders <span class="ml-1 badge badge-success"><?= count($tableDetails) ?? 0; ?></span></button>
		</div>
		<div class="col-md-4 text-center">
		<button class="btn btn-block btn-default" onclick="runningOrder('2')">Takeaway <span class="ml-1 badge badge-success"><?= count($newOrdersCount) ?? 0; ?></span></button>
		</div>
		</div>
				</div>
				</div>
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-header d-flex align-items-center">
                <h3 class="h4 float-left col-md-8">New Orders</h3>
              ...
              <div class="card-body p-3">
				...
				<div class="row">
				    <?php
				    if($tableDetails[$i]['orderprocess'] == '0'){
				        $color = 'red';
				    } 
				    else if($tableDetails[$i]['orderprocess'] == '1'){
				        $color = 'orange';
				    } 
					else if($tableDetails[$i]['orderprocess'] == '2'){
				        $color = 'Yellow';
				    }  
				    ?>
...
<!--				<div class="row">
				...
				<div class="col-md-4">
							<?php if($tableDetails[$i]['ordertype'] == 1){ echo 'Online'; }else{  echo 'Multi QR'; }  ?> 
				...
				<button class="placeorder btn"  onclick="placeOrder('<?= $tableDetails[$i]['tableId'] ;?>','<?= $tableDetails[$i]['name'] ;?>','<?= $tableDetails[$i]['current_order_id'] ;?>')">Order Details</button>
                                
                                <!--<button type="button" class="badge badge-success mb-0" onclick="placeOrder('<?= $tableDetails[$i]['tableId'] ;?>','<?= $tableDetails[$i]['name'] ;?>','<?= $tableDetails[$i]['current_order_id'] ;?>')"><i class="fa fa-plus" title="Add More"></i></button>-->
