   ...
   echo SweetAlert::widget([
    'options' => [
		...
		<section class="col-md-12">
			  ...
			  <div class="card-header d-flex align-items-center pt-0 pb-0 mb-4">
...
<span class="nav__link nav__link--has-dropdown" onclick="placeOrder('<?= $tableDetails[$t]['ID']?>','<?= $tableDetails[$t]['name']?>','<?= $tableDetails[$t]['current_order_id']?>')">
        ...
        <button id="nav__scroll--left" class="nav__scroll nav__scroll--left hide" style="left: 1322px;"><i class="fa fa-arrow-left"></i></button>
        <button id="nav__scroll--right" class="nav__scroll nav__scroll--right nav__scroll--visible"><i class="fa fa-arrow-right"></i></button>
    </nav>
...
<?php } ?>
						<button type="button" class="btn btn-add btn-xs"><i class="fa fa-print" title="KOT"></i></button>
						</div>
						</div>
		  </div>
		  </div>
