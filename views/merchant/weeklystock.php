          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header d-flex align-items-center pt-0 pb-0">
                <h3 class="h4 col-md-6 pl-0 tab-title">Add Weekly Stock</h3>
				<div class="col-md-6 text-right pr-0">
				<button type="button" class="btn btn-add btn-xs" id="myBtn" data-toggle="modal" data-target="#myModal">
				<i class="fa fa-plus mr-1"></i> Add Weekly Stock</button>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Add Weekly Stock</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
		<form action="saveinvetaryupdaterequest" id="addinventory" method="POST">
		    <div class="form-group">
                  ...
                  <input type="text" class="form-control datepicker1" name="reg_date" placeholder="Record Date" value="<?= $sdate ; ?>">
                </div>
                  </div>
...
<div class="modal-dialog modal-xl" >
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Weekly Stock</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
...
$("#btnAddRec").click(function(){
	...
	function viewInvetaryUpdateDetails(id){
	    ...
	    var purchaseBody = '<div class="form-group row">\
		            ...
		            <div class="col-md-2">'+purchaseDet[0]['reg_date'];
