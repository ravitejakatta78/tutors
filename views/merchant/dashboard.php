...
<div class="main">
                ...
                <div class="row p-0">
                    ...
                    <div class="statistics col-lg-4 col-12">
                        ...
                        <div role="progressbar" style="width: 25%; height: 4px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
                                ...
                                <div class="number"><strong class="counter"><a
                ...
                <div class="col-md-12 pl-0 pr-0">
                    <div class="card">
                        <div class="card-header">
                            <div class="row p-0">
                                <div class="col-md-2">
                                    <h3 class="h4 pl-0 tab-title">Total Sales</h3>
                                </div>
                                <div class="col-md-10">
                                    <div class="row p-0">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control datepicker9" id="datepicker9"
                                                value="<?= date('Y-m-d'); ?>" style="display:none">
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control datepicker10" id="datepicker10"
                                                value="<?= date('Y-m-d'); ?>" style="display:none">
                                        </div>
                                        <div class="col-md-3">
                                            <div>
                                        ...
                                        <div class="col-md-1">
                                            <button class="btn btn-primary" id="search3">Go</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-header">
                            <div class="row p-0">
                                ...
                                <div class="col-md-10">
                                    <div class="row p-0">
                                        <div class="col-md-4">
                                            <input type="text" class="form-control datepicker3" id="datepicker3"
                                                value="<?= date('Y-m-d'); ?>" style="display:none">
                                        </div>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control datepicker4" id="datepicker4"
                                                value="<?= date('Y-m-d'); ?>" style="display:none">
                                        </div>
                                        <div class="col-md-3">
                                            <div>
                        ...
                        <div class="card-header d-flex">
                            ...
                            <div class="col-md-10">
                                <div class="row p-0">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control datepicker6" id="datepicker6"
                                            value="<?= date('Y-m-d'); ?>" style="display:none">
                                    </div>
                                    <div class="col-md-3">
                                        <div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex">
                            ...
                            <div class="col-md-10">
                                <div class="row p-0">
                                    <div class="col-md-4">
                                        <input type="text" class="form-control datepicker7" id="datepicker7"
                                            value="<?= date('Y-m-d'); ?>" style="display:none">
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control datepicker8" id="datepicker8"
                                            value="<?= date('Y-m-d'); ?>" style="display:none">
                                    </div>
                                    <div class="col-md-3">
                                        <div>
                ...
                <div class="col-md-12 pl-0 pr-0">
                        ...
                        <div class="card-body text-center">
                            <div class="row">
                                ...
                                <div class="col-md-6 statistic mb-0">
                                    <div class="text"><strong
                                            class="counter"><?= round($resPaidCOunt['paidOnline']) ?? 0; ?></strong><br><small
                                            style="color:grey;">Online Payment</small></div>
                                </div>
                            </div>
                            <hr class="mt-0 mb-0">
                            <div class="row">
                                <div class="col-md-6 statistic mb-0" style="border-right: 1px solid #e8e8e8;">
                                    <div class="text"><strong
                                            class="counter"><?= round($resPaidCOunt['runningOrders']) ?? 0; ?></strong><br><small
                                            style="color:grey;">Running Orders</small></div>
                                </div>
                                <div class="col-md-6 statistic mb-0">
                                    <div class="text"><strong
                                            class="counter"><?= ($productCount) ?? 0; ?></strong><br><small
                                            style="color:grey;">Total Items</small></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="chart col-lg-12 col-12 pl-0 pr-0">
                        ...
                        <div class="statistic d-flex align-items-center bg-white has-shadow">
                            ...
                            <div class="text"><strong><a style="cursor: pointer;color:black;text-decoration:none;"
                                        href="<?= Url::to(['merchant/pilot']); ?>">Pilot Data</a></strong></div>
                        </div>
                        <!--<div class="statistic d-flex align-items-center bg-white has-shadow">-->
                        ...
                        <div class="statistic d-flex align-items-center bg-white has-shadow">
                            ...
                            <div class="text"><strong><a style="cursor: pointer;color:black;text-decoration:none;"
                                        href="<?= Url::to(['merchant/rating']); ?>">Feedback</a></strong></div>
                        </div>

                        <div class="statistic d-flex align-items-center bg-white has-shadow">
                            <div class="icon bg-success"><i class="fa fa-houzz"></i></div>
                            <div class="text"><strong><a style="cursor: pointer;color:black;text-decoration:none;"
                                        href="<?= Url::to(['merchant/ingredientstock']); ?>">Stock Updates</a></strong>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  dataSource: {
    ...
    $("#search3").click(function() {
        var date1 = $("#datepicker9").val();
        var date2 = $("#datepicker10").val();
        ...
        $("#chart-customermap").insertFusionCharts({
            ...
            dataSource: {
                chart: {
                    ...
                    yaxisname: "Orders",
                    formatnumberscale: "1",
                    plottooltext: "<b>$dataValue</b> <b>$seriesName</b> orders on $label",
                    theme: "fusion",
                    drawcrossline: "1"
                },
                categories: [{
    ...
    function totalSaleChart(totalSaleChartDet)
    {
        var totalSaleChartArr = JSON.parse(totalSaleChartDet);
        $("#chart-containerr").insertFusionCharts({
            ...
            dataSource: {
                "chart": {
                    ...
                    "startingAngle": "310",
                    "showLegend": "1",
                    "defaultCenterLabel": "Total revenue: "+totalSaleChartArr['runningTotalAmount'],
                ...
                data: totalSaleChartArr['runningPie']
            ...
            var chartObj = new FusionCharts({
                ...
                dataSource: {
                    "chart": {
                        ...
                        "startingAngle": "310",
                        "showLegend": "1",
                        "defaultCenterLabel": "Total revenue: "+totalSaleChartArr['completedTotalAmount'],
                        "centerLabel": "$label : $value",
                        "centerLabelBold": "1",
                        "showTooltip": "0",
                        "decimals": "0",
                    ...
                    "data": totalSaleChartArr['completedPie']
                }
            });
            chartObj.render();
        });
