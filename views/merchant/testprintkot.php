    ...
    <body onload="window.print()">
        ...
        <div class="ticket">
            ...
            ?>
                ...
                <span class="divider">Proceessed By:&nbsp;<?= $merchantDet['storename']; ?></span><span class="right">Bill No:&nbsp;<?= $orderDet['order_id']; ?></span><br>
                <span class="divider">Customer Info:&nbsp;<?= !empty($user_det['name']) ? $user_det['name'] : 'Guest' ; ?></span><span class="right"><?= $section_det['section_name']; ?> - <?= $tableDet['name']; ?></span><br>
                <hr>
