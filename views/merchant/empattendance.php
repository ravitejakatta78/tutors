              ...
              <div class="card-body">
				...
				<table id="example" class="table table-striped table-bordered ">
					...
					<tbody>
						...
						?>
                            <tr>
                                <td> <input name="ckcEmp[]" class="individualcheck" type="checkbox" value="<?= $empModel['ID']; ?>" /></td>
                ...
                <?php } else {?>
				<div>Today Attendance Already Taken </div>
				<?php } ?>
				</div>
				<div class="col-md-12 mt-4 text-right">
				<button type="submit" class="btn btn-add">Add Attendance</button>
				</div>
				</form>
              </div>
            </div>
