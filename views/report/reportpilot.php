...
<section>
    <div class="col-lg-12">
		...
		<div class="col-md-6 text-right pr-0">
            ...
            <div class="card-body">
		<form class="form-inline" method="POST" action="reportpilot">
			   ...
			   <div class="form-group row">
                  ...
                  <div class="form-group pt-3">
                        <button type="button" onclick="pilotviews()" class="btn btn-add btn-sm btn-search">Search</button>
                    </div>
                    </div>
                    <div class="col">
	...
	<td>dfswe</td>
        ...
        form.setAttribute('action','reportpilot');
