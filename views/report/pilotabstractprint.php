...
<div class="container">
	...
	<tr>
		...
		<td align="center"><?= $pilot['serviceboyname']; ?></td>
                <td align="center"><?= $pilot['order_id']; ?></td>
		<td align="center"><?= date('d-M-Y',strtotime($pilot['reg_date'])); ?></td>
                <td align="center"><?= $pilot['status']; ?></td>
                <td align="center"><?= round($pilot['totalamount'],2); ?></td>
                <td align="center"><?= $pilot['username']; ?></td>
	</tr>
	<?php $i++; } ?>
	</tbody>
	</table>
