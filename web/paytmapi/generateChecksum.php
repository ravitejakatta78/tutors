...
if (array_key_exists('merchantkey', $paramList)) {
    unset($paramList['merchantkey']); 
}
...
$checkSum = getChecksumFromArray($paramList,$merchantkey);
 ...
 echo json_encode(array("CHECKSUMHASH" => $checkSum,"ORDER_ID" => $_REQUEST["ORDER_ID"], "payt_STATUS" => "1"),JSON_UNESCAPED_SLASHES);
